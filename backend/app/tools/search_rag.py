"""
FinResearch AI - Research / Market / Financial Data Tools

Important design rule:
    Company -> Canonical ticker -> Real provider -> Evidence

This module intentionally does NOT contain hardcoded stock prices,
hardcoded financial statements, or hardcoded company news.
"""
...
HEADERS = {
    "User-Agent": "FinResearchAI/1.0 research-system contact=finresearch@example.com",
...
def web_search_news(
    ...
    try:
        response = requests.get(
            ...
            headers={
                "User-Agent": "Mozilla/5.0 FinResearchAI/1.0"
            },
            timeout=REQUEST_TIMEOUT,
        )
        ...
        raise RuntimeError(
            f"News search failed for {company}: {e}"
        )
